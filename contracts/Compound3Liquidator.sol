...
contract Compound3Liquidator is Ownable, IUniswapV3SwapCallback, IApi3ServerV1OevExtensionOevBidPayer {
  ...
  address public constant API3_SERVER_V1_OEV_EXTENSION = 0x2E787629c3B7545271240A87197108823ce8303b;
  ...
  function onOevBidPayment(uint256 bidAmount, bytes calldata _data) external override returns (bytes32) {
    ...
    _withdrawWeth();
    API3_SERVER_V1_OEV_EXTENSION.call{ value: bidAmount }('');
