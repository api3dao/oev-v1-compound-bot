...
export const env = cleanEnv(process.env, {
  ...
  MAX_SIMULATE_LIQUIDATIONS_MULTICALL: num(),
  MIN_POSITION_USD_E18: etherValidator(),
  MIN_RPC_DELAY_MS: num(),
  OEV_NETWORK_RPC_URL: str(),
  OEV_PLACE_BID_TRANSACTION_TIMEOUT_MS: num(),
  OEV_POLL_AWARD_BID_DELAY_MS: num(),
  OEV_REPORT_FULFILLMENT_TIMEOUT_MS: num(),
